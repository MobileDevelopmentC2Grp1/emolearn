...
List<HardQuestion> hardList = [
  ...
  HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/grape_hard.png",
      answer: "grape"),
  HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/kiwi_hard.png",
      answer: "kiwi"),
  HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/banana_hard.png",
      answer: "banana"),
  HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/strawberry_hard.png",
      answer: "strawberry"),
  HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/pineapple_hard.png",
      answer: "pineapple"),
  HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/craneberry_hard.png",
      answer: "craneberry"),
      HardQuestion(
      question: "Guess the fruit",
      imageUrl: "images/coconut_hard.png",
      answer: "coconut"),
];
